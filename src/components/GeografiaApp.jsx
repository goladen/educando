  ...
  config.forEach(({ seccionId, cantidad, tipo }) => {
    ...
    shuffled.forEach(elem => {
      ...
      preguntas.push({
        ...
        nameAlt: elem.nameAlt ?? null,
        lon: elem.lon ?? null, lat: elem.lat ?? null,
        lon_inicio: elem.lon_inicio ?? null, lat_inicio: elem.lat_inicio ?? null,
        lon_fin: elem.lon_fin ?? null, lat_fin: elem.lat_fin ?? null,
        tipo,
        opciones,
      });
    });
