...
// end include: preamble.js
  ...
  function _GetUrlParam(param) {
          ...
          try {
              ...
              var value = url.searchParams.get(paramStr) || "";
          } catch(e) {
              var value = "";
          }
  ...
  function _SendResultToParent(json) {
          var jsonStr = UTF8ToString(json);
          try {
              var data = JSON.parse(jsonStr);
              window.parent.postMessage({ type: 'KARTINGED_RESULT', data: data }, '*');
          } catch(e) {
              console.error('KartingedBridge SendResultToParent error:', e);
          }
      }
...
var wasmImports = {
  ...
  "SendResultToParent": _SendResultToParent,
