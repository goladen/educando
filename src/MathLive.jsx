...
function MathLiveHost({ codigoSala, onExit, usuario }) {
        ...
        if (faseHost === 'JUEGO' && subFase === 'RESPONDING' && gameData) {
            ...
            timerRef.current = setInterval(() => {
                ...
                if (restante <= 0) {
                    ...
                    // Usamos la referencia para asegurar que tenemos las respuestas más nuevas
    ...
    const enviarInformeProfesor = async () => {
        ...
        try {
            ...
            await addDoc(collection(db, 'informes_juegos'), {
                tipo: 'MATHLIVE', modalidad: 'Online', fecha: new Date(),
                recursoId: gameData.recursoId || '', recursoTitulo: gameData.recursoTitulo || 'MathLive',
    ...
    const terminarTiempo = () => {
        ...
        // 2. Forzamos pasar a "Revelar Respuestas" usando los datos más recientes
        // (Usamos gameDataRef para evitar bugs si el estado no se ha actualizado)
